...
const App = () => {
  ...
  const ai = new GoogleGenAI({ apiKey: "AIzaSyAu2jfNn3VEd4AHDHTR0gQXr7O4weF3ZY4" }); // 👈 replce "YOUR_API_KEY" with your api key
        ...
        screen === 1 ?
          <>
            <div className="container flex flex-col items-center justify-center h-screen ">
              ...
              <button onClick={generateBlogContent} className="btnNormal py-[15px] transition-all duration-300 hover:bg-purple-600 px-[20px] bg-purple-500 text-white rounded-xl border-0 outline-0 mt-6 w-[40vw]">
  Generate
</button>
